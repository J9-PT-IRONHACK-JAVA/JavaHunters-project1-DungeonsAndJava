...
//        startFight(userParty, iaParty);
    ...
    public static Party teamUp(Scanner sc) throws FileNotFoundException {
        ...
        switch (typeOfParty) {
            ...
            case "2":
                ...
                partyToReturn = saveCharactersToParty(charactersArray, members, sc);
                System.out.println(partyToReturn.toString());
                break;
            case "3":
                ...
                partyToReturn = saveRandomParty(sameRange, correctRange, members, charactersArray);
                System.out.println(partyToReturn.toString());
                break;
            default:
